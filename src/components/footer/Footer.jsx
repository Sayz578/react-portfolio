...
const Footer = () => {
    ...
    const scrollButton = () => window.pageYOffset > 200 ? setShowButton(true) : setShowButton(false)
    ...
    useEffect(() => {
        ...
        return () => window.removeEventListener("scroll", scrollButton)
    ...
    return (
        <>
            ...
            <div className={`arrow-top ${showButton ? "active" : ""}`} onClick={scrollToTop}>
                <FaArrowUp />
            </div>
        </>
